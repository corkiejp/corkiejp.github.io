...
- **`uri` Parameter:**
    ...
    - The user can then fetch the single record or modify the fields for further queries. Also supports the Bluesky web urls. Both can be enter/paste on the page URI field. 
    - Example:
