...
async function leafletExists(id) {
  ...
  try {
    ...
    return htmlHasLeafletPdfMeta(html);
  } catch {
    return false;
  }
}
  ...
  overlay.innerHTML = `
    ...
    <div class="svlv-panel" role="dialog" aria-modal="true" aria-label="SuperValu leaflet viewer">
      <div class="svlv-toolbar">
        ...
        <span class="svlv-leaflet-label"> <span></span></span>
        <span class="svlv-page-label"></span>
        <div class="svlv-spacer"></div>
		
		  <button class="svlv-btn" data-act="prev-leaflet" title="Go to previous leaflet">
    Prev leaflet
  </button>
  <button class="svlv-btn" data-act="next-leaflet" title="Go to next leaflet">
    Next leaflet
  </button>
