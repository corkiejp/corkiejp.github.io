...
Install/Builds: - [Chromium .zip](https://corkiejp.github.io/myviewers/localsearch/local-search-newtab-plus-reorder%20(2).zip) or [Firefox .xpi](https://corkiejp.github.io/myviewers/localsearch/LS-Firefox.zip.xpi) 
